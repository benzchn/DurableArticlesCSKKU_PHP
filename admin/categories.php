            ...
            <form class="form-horizontal" id="submitCategoriesForm" action="php_action/createCategories.php"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="categoriesName" class="col-sm-4 control-label">รหัสประเภทครุภัณฑ์ </label>
                        <label class="col-sm-1 control-label">: </label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="categoriesCode" placeholder="รหัสประเภท"
                                name="categoriesCode" autocomplete="off">
                        </div>
                    </div> <!-- /form-group-->
                    <div class="form-group">
                        <label for="categoriesName" class="col-sm-4 control-label">ชื่อประเภทครุภัณฑ์ </label>
                        <label class="col-sm-1 control-label">: </label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="categoriesName" placeholder="ชื่อประเภท"
            ...
            <form class="form-horizontal" id="editCategoriesForm" action="php_action/editCategories.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="edit-categories-result">
                        ...
                        <div class="form-group">
                            <label for="editCategoriesCode" class="col-sm-4 control-label">รหัสประเภทครุภัณฑ์</label>
                            <label class="col-sm-1 control-label">: </label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="editCategoriesCode" placeholder="รหัสประเภท"
                                    name="editCategoriesCode" autocomplete="off">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="editCategoriesName" class="col-sm-4 control-label">ชื่อประเภทครุภัณฑ์</label>
                            <label class="col-sm-1 control-label">: </label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="editCategoriesName" placeholder="ชื่อประเภท"
