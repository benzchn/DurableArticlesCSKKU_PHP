...
$sql = "SELECT * FROM users_personal WHERE user_id = '$user_id' ";
			...
			<div class="panel-body">
				...
				<form action="php_action/changeUsername.php" method="post" class="form-horizontal" id="changeUsernameForm">
					<fieldset>
					    ...
					    <div class="col-sm-10">
					      <input type="text" class="form-control" id="username" name="username" placeholder="Username" value="<?php echo $result['user_id']; ?>"/>
					    </div>
					  </div>
